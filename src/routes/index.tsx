    ...
    >
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        <a href="#home" className="flex items-center gap-3">
          <img src={logoAsset} alt="Aadhya Events" className="h-14 w-14 sm:h-16 sm:w-16 object-contain brightness-50 contrast-125 drop-shadow-lg" />
    ...
    <section className="on-dark relative isolate flex min-h-screen items-center pt-28">
      ...
      <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl">
          <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-[var(--gold)]/30 bg-[var(--gold)]/5 px-5 py-2 text-xs uppercase tracking-[0.2em] text-[var(--label-gold)] backdrop-blur">
            <Sparkles className="h-3.5 w-3.5" /> AHMEDABAD'S FASTEST GROWING EVENT COMMUNITY
          </div>
    ...
    <footer className="on-dark relative mt-12 border-t border-[var(--gold)]/20" style={{ background: "var(--gradient-emerald)" }}>
      <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
        <div className="grid gap-10 lg:grid-cols-3">
          <div>
            <div className="flex items-center gap-4">
              <img src={logoAsset} alt="Aadhya Events" className="h-20 w-20 object-contain brightness-50 contrast-125 drop-shadow-lg" />
              <div>
